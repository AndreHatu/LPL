	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="gerenciar_livros.aspx">Livros Trocados <span class="badge">
					<asp:Label runat="server" ID="lblTrocados"></asp:Label></span></a></li>
				<li>
					<img class="margin-top-10" src="/Arvore.ashx?id=<%=CaminhoDaImagem %>" alt="Badge" width="35" height="35" /></li>
				<li class="dropdown">
