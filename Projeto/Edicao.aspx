<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edicao.aspx.cs" Inherits="Projeto.Edicao" %>
                ...
                <div class="col-md-8">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <asp:TextBox runat="server" CssClass="form-control" ID="txtNomeLivro" placeholder="Nome do Livro Aqui"></asp:TextBox>
                        ...
                        <div class="text-center row">
                            <asp:Button runat="server" CssClass="btn btn-success btn-lg" Text="Salvar Livro" ID="btnSalvarLivro" OnClick="btnSalvar_Click" />
                        </div>
                    </div>
                </div>
